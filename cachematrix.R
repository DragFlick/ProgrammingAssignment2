...
## 	AS SUGGESTED, THE FIRST FUNCTION makeCacheMatrix() CREATES THE SOURCE MATRIX. THE FUNCTION CONSISTS OF VARIOUS CONSTRUCTOR FUNCTIONS. 
## 	FUNCTION(get_source_matrix()) CREATES THE SOURCE MATRIX ) ,FUNCTION (set_source_matrix()) SETS THE VALUE OF THE SOURCE MATRIX 
## 	,FUNCTION (get_inverse_matrix()) FETCH THE INVERSE MATRIX FROM THE CACHE AND FUNCTION (set_inverse_matrix()) SET THE VALUE OF THE 
## 	INVERSE MATRIX IN CACHE

##  cacheSolve() FUNCTION EVALUATE THE INVERSE OF THE MATRIX IN CASE THE INVERSE IS NOT PRESENT IN CACHE AND POPULATES THE CACHE. IN CASE, 
##  THERE ARE SUBSEQUENT FUNCTION CALLS WITH SAME INPUT , THE FUNCTION ACCESSES THE CACHE TO EXTRACT THE VALUE OF THE 
##  INVERSE
...
## AND THEREAFTER CONVERTS THE VECTOR INTO A SQUARE MATRIX. IT ALSO CREATES CONSTRUCTOR FUNCTION TO EXTRACT OR SET 
## DATA VALUES WITHIN THE MATRIX OBEJCT AND RETURN A LIST OF FUNCTIONS 
